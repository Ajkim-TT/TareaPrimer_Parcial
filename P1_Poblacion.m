...
if N < 0
    ...
    elseif NF ~= 0 && NM == 0
        prom_W_F = prom_W_F/NM;
        prom_H_F = prom_H_F/NM;
        texto1 = sprintf('El promedio de peso masculino es %d',string(prom_W_F));
        texto2 = sprintf('El promedio de altura masculino es %d',string(prom_H_F));
        texto3 = sprintf('El promedio de peso general es %d',string(prom_W_F));
        texto4 = sprintf('El promedio de altura general es %d',string(prom_H_F));
        disp(texto1)
        disp(texto2)
        disp(texto3)
        disp(texto4)
        ...
        prom_W_M = prom_W_M/NM;
        prom_H_M = prom_H_M/NM;
        prom_W_G = prom_W_G/NM;
        prom_H_G = prom_H_G/NM;
        texto1 = sprintf('El promedio de peso masculino es %d',string(prom_W_M));
        texto2 = sprintf('El promedio de altura masculino es %d',string(prom_H_M));
        texto3 = sprintf('El promedio de peso femenino es %d',string(prom_W_F));
        texto4 = sprintf('El promedio de altura femenino es %d',string(prom_H_F));
        texto5 = sprintf('El promedio de peso general es %d',string(prom_W_G));
        texto6 = sprintf('El promedio de altura general es %d',string(prom_H_G));
        disp(texto1)
        disp(texto2)
        disp(texto3)
        disp(texto4)
